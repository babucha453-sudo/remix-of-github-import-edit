...
export default function ReputationSuite() {
  ...
  if (!canAccessSuite) {
    return (
      <div className="space-y-6">
        <div className="p-5 rounded-2xl bg-white/90 border border-gray-700/50">
          <h1 className="text-2xl font-display font-bold text-gray-900">Reputation Suite</h1>
          <p className="text-gray-900/60 mt-1">Professional review management & analytics</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Card className="bg-gold border-gold">
            <CardContent className="p-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{clinic.rating?.toFixed(1) || 'N/A'}</p>
            </CardContent>
          </Card>
          <Card className="bg-primary border-primary">
            <CardContent className="p-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{clinic.review_count || 0}</p>
            </CardContent>
          </Card>
          <Card className="bg-teal border-teal">
            <CardContent className="p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-medium text-gray-900/70">Positive</span>
              </div>
              <p className="text-2xl font-bold text-gray-900">{kpis.thumbsUp}</p>
            </CardContent>
          </Card>
          <Card className="bg-coral border-coral">
            <CardContent className="p-4">
              <div className="flex items-center gap-2 mb-2">
                <ThumbsDown className="h-4 w-4 text-gray-900" />
                <span className="text-xs font-medium text-gray-900/70">Private</span>
              </div>
              <p className="text-2xl font-bold text-gray-900">{kpis.thumbsDown}</p>
            </CardContent>
          </Card>
        </div>
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="flex items-start justify-between p-5 rounded-2xl bg-white/90 border border-gray-700/50 shadow-lg">
        <div>
          <h1 className="text-2xl font-display font-bold text-gray-900">
            Reputation Suite
          </h1>
          <p className="text-gray-900/60 mt-1">Real-time reputation analytics for {clinic.name}</p>
        </div>
        <div className="flex gap-2">
          <Dialog open={qrDialogOpen} onOpenChange={setQrDialogOpen}>
            <DialogTrigger asChild>
              <Button variant="outline" className="gap-2 border-gray-600/50 text-gray-900 hover:bg-slate-700/50">
          ...
          <Button onClick={copyLink} className="gap-2 bg-primary hover:bg-primary/90 text-gray-900">
      ...
      <div className="grid lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-white/90 border border-gray-700/50 text-gray-900 overflow-hidden shadow-lg">
          <div className="h-1 bg-gradient-to-r from-primary via-teal to-primary" />
          <CardContent className="p-5">
            <div className="flex items-center gap-2 mb-3">
              <Activity className="h-4 w-4 text-primary" />
              <span className="text-xs font-medium text-gray-900/60">Reputation Score</span>
            </div>
        ...
        <Card className="bg-gold border-gold">
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-2">
              <Star className="h-4 w-4 text-gray-900" />
              <span className="text-xs font-medium text-gray-900/70">Avg Rating</span>
            </div>
            <p className="text-2xl font-bold text-gray-900">{kpis.avgRating.toFixed(1)}</p>
            <div className="flex items-center gap-0.5 mt-1">
              {[1,2,3,4,5].map(i => (
                <Star key={i} className={cn("h-3 w-3", i <= kpis.avgRating ? 'text-gray-900 fill-white' : 'text-gray-900/30')} />
              ))}
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-teal border-teal">
          <CardContent className="p-4">
            <div className="flex items-center gap-2 mb-2">
              <ThumbsUp className="h-4 w-4 text-gray-900" />
              <span className="text-xs font-medium text-gray-900/70">→ Google</span>
            </div>
            <p className="text-2xl font-bold text-gray-900">{kpis.thumbsUp}</p>
            <p className="text-xs text-gray-900/60 mt-1">Redirected</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-coral border-coral">
          <CardContent className="p-4">
            ...
            <p className="text-2xl font-bold text-gray-900">{kpis.thumbsDown}</p>
            <p className="text-xs text-gray-900/60 mt-1">Captured</p>
          </CardContent>
        </Card>
      </div>

      {/* Review Link Card */}
      <Card className="bg-white/90 border border-gray-700/50 shadow-lg">
        <div className="h-1 bg-gradient-to-r from-primary via-teal to-primary" />
        <CardContent className="p-4">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Review Collection Link</h3>
                <p className="text-sm text-gray-900/60">Happy → Google • Unhappy → Private</p>
              </div>
            </div>
            <div className="flex items-center gap-2 flex-1 max-w-lg">
              <Input value={reviewLink} readOnly className="bg-slate-900/50 border-gray-600/50 font-mono text-sm text-gray-900" />
              <Button onClick={copyLink} size="icon" variant="outline" className="border-gray-600/50 hover:bg-slate-700/50 shrink-0">
                {linkCopied ? <CheckCircle className="h-4 w-4 text-teal" /> : <Copy className="h-4 w-4 text-gray-900" />}
              </Button>
              {googleReviewLink && (
                <Button variant="outline" size="icon" className="border-gray-600/50 hover:bg-slate-700/50 shrink-0" asChild>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-5 h-11 rounded-xl bg-slate-900 p-1 border border-gray-700/50">
          <TabsTrigger value="overview" className="rounded-lg text-gray-900 data-[state=active]:bg-slate-700 data-[state=active]:text-gray-900">
            <BarChart3 className="h-4 w-4 mr-2" />
            Overview
          </TabsTrigger>
          <TabsTrigger value="inbox" className="rounded-lg text-gray-900 data-[state=active]:bg-slate-700 data-[state=active]:text-gray-900">
            <MessageSquare className="h-4 w-4 mr-2" />
            Inbox
            {kpis.thumbsDown > 0 && (
              <Badge className="ml-2 h-5 bg-coral text-gray-900 border-0">{kpis.thumbsDown}</Badge>
            )}
          </TabsTrigger>
          <TabsTrigger value="send" className="rounded-lg text-gray-900 data-[state=active]:bg-slate-700 data-[state=active]:text-gray-900">
            <Send className="h-4 w-4 mr-2" />
            Send Requests
          </TabsTrigger>
          <TabsTrigger value="tracking" className="rounded-lg text-gray-900 data-[state=active]:bg-slate-700 data-[state=active]:text-gray-900">
            <Eye className="h-4 w-4 mr-2" />
            Tracking
          </TabsTrigger>
          <TabsTrigger value="ai" className="rounded-lg text-gray-900 data-[state=active]:bg-slate-700 data-[state=active]:text-gray-900">
        ...
        <TabsContent value="overview" className="mt-6">
          <div className="grid lg:grid-cols-2 gap-6">
              ...
              <CardContent className="space-y-4">
                {[
                  ...
                  <div key={item.step} className="flex gap-3 items-start">
                    <div className={cn("h-8 w-8 rounded-lg flex items-center justify-center shrink-0 text-sm font-bold text-gray-900", item.color)}>
                      {item.icon ? <item.icon className="h-4 w-4" /> : item.step}
                    </div>
                    <div>
                      <p className="font-semibold text-gray-900 text-sm">{item.title}</p>
                      <p className="text-xs text-gray-900/60">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </CardContent>
            ...
            <Card className="bg-white/90 border border-gray-700/50 shadow-lg">
              ...
              <CardContent>
                <div className="text-center p-6 rounded-xl bg-slate-900/50 border border-gray-700/50 mb-4">
                  <p className="text-4xl font-bold text-primary">
                    {kpis.totalResponses > 0 ? Math.round((kpis.thumbsUp / kpis.totalResponses) * 100) : 0}%
                  </p>
                  <p className="text-gray-900/60 text-sm mt-1">Conversion to Google</p>
                </div>
                <div className="space-y-3">
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      <span className="flex items-center gap-2 text-gray-900/80">
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-gray-900/60">Review and respond to patient feedback</CardDescription>
                </div>
                <div className="flex items-center gap-2">
                  <Button 
                    ...
                    className={cn("border-gray-600/50 text-gray-900 hover:bg-slate-700/50", !filterRating && 'bg-slate-700/50')}
                  >
                    All
                  </Button>
                  {[1,2,3,4,5].map(r => (
                    <Button 
                      ...
                      className={cn("border-gray-600/50 text-gray-900 hover:bg-slate-700/50", filterRating === r && 'bg-slate-700/50')}
                    >
                      {r}★
                    </Button>
                  ))}
            ...
            <CardContent>
              {eventsLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-900/60">No negative feedback. Great work!</p>
                </div>
              ) : (
                <ScrollArea className="h-[400px]">
                  <div className="space-y-3 pr-4">
                    {filteredEvents.map((event) => (
                      <div key={event.id} className="p-4 rounded-xl bg-slate-900/50 border border-gray-700/50">
                        <div className="flex items-start justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <Badge variant="outline" className="capitalize text-xs border-gray-600/50 text-gray-900/70">{event.source}</Badge>
                          </div>
                        ...
                        {event.comment && (
                          <p className="mt-3 text-sm text-gray-900/80">{event.comment}</p>
                        )}
                      </div>
                    ))}
                  </div>
              ...
              <Card className="bg-white/90 border border-gray-700/50 shadow-lg">
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <CardDescription className="text-gray-900/60">Choose a channel and send personalized requests</CardDescription>
                    </div>
                    <Dialog open={showSendDialog} onOpenChange={setShowSendDialog}>
                      <DialogTrigger asChild>
                        <Button className="gap-2 bg-primary hover:bg-primary/90 text-gray-900 font-semibold">
                          <Plus className="h-4 w-4" />
                          New Request
                        </Button>
                      </DialogTrigger>
                      <DialogContent className="bg-slate-900 border-gray-700/50 max-w-lg">
                        <DialogHeader>
                          <DialogTitle className="text-gray-900">Send Review Request</DialogTitle>
                          <DialogDescription className="text-gray-900/60">Choose a patient or enter details manually</DialogDescription>
                        </DialogHeader>
                        ...
                        <div className="space-y-5 py-4 pr-2">
                          ...
                          {inputMode === 'patient' && (
                            <div className="space-y-2">
                              <Label className="text-gray-900 font-medium">Choose Patient</Label>
                              <Select value={selectedPatientId || ''} onValueChange={handlePatientSelect}>
                                <SelectTrigger className="bg-white border-gray-600 text-gray-900 h-11">
                                  <SelectValue placeholder="Select a patient..." />
                                </SelectTrigger>
                                <SelectContent className="bg-white border-gray-700 max-h-60">
                                  {patients.map((p) => (
                                    <SelectItem key={p.id} value={p.id} className="text-gray-900 hover:bg-slate-700">
                                      <div className="flex items-center gap-2">
                                        ...
                                        <span>{p.name}</span>
                                        <span className="text-gray-900/40 text-xs">• {p.phone}</span>
                                      </div>
                                    </SelectItem>
                                  ))}
                                </SelectContent>
                              ...
                              {patients.length === 0 && (
                                <p className="text-sm text-gray-900/40">No patients found. Use manual entry.</p>
                              )}
                            </div>
                          )}
                          ...
                          {inputMode === 'manual' && (
                            <div className="space-y-3">
                              <div className="space-y-2">
                                <Label className="text-gray-900 font-medium">Patient Name</Label>
                                <Input
                                  placeholder="John Smith"
                                  value={recipientName}
                                  onChange={(e) => setRecipientName(e.target.value)}
                                  className="bg-white border-gray-600 text-gray-900 h-11"
                                />
                              </div>
                              {sendChannel === 'email' ? (
                                <div className="space-y-2">
                          ...
                          {/* Channel Selection */}
                          <div className="space-y-2">
                            <Label className="text-gray-900 font-medium">Channel</Label>
                              ...
                              {[
                                ...
                                >
                                  <div className={cn("h-10 w-10 rounded-lg flex items-center justify-center", ch.color)}>
                                    <ch.icon className="h-5 w-5 text-gray-900" />
                                  </div>
                                  <span className="text-xs font-semibold text-gray-900">{ch.label}</span>
                                </button>
                              ))}
                            </div>
                          </div>
                              ...
                              {MESSAGE_TEMPLATES.map((t) => (
                                ...
                                >
                                  ...
                                  <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-gray-900/50 truncate">{t.description}</p>
                                  </div>
                                  {selectedTemplate === t.id && (
                          ...
                          <div className="space-y-2">
                            <Label className="text-gray-900 font-medium">Custom Message (Optional)</Label>
                            <Textarea
                              placeholder="Override the template with your own message..."
                              value={customMessage}
                              onChange={(e) => setCustomMessage(e.target.value)}
                              rows={3}
                              className="bg-white border-gray-600 text-gray-900 resize-none"
                            />
                          </div>
                        </div>
                        </ScrollArea>
                        <DialogFooter className="border-t border-gray-700 pt-4">
                          <Button variant="outline" onClick={() => setShowSendDialog(false)} className="border-gray-600 text-gray-900">
                            Cancel
                          </Button>
                          <Button
                            onClick={() => sendRequestMutation.mutate()}
                            disabled={!recipientName || (sendChannel === 'email' ? !recipientEmail : !recipientPhone) || sendRequestMutation.isPending}
                            className="bg-primary hover:bg-primary/90 text-gray-900 font-semibold gap-2"
                          >
                ...
                <CardContent>
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-6">
                    <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs font-medium text-gray-900/60">Via Email</span>
                      </div>
                      <p className="text-2xl font-bold text-gray-900">{kpis.sentViaEmail}</p>
                    </div>
                    <div className="p-4 rounded-xl bg-teal/10 border border-teal/20">
                      <div className="flex items-center gap-2 mb-2">
                        <Phone className="h-4 w-4 text-teal" />
                        <span className="text-xs font-medium text-gray-900/60">Via SMS</span>
                      </div>
                      <p className="text-2xl font-bold text-gray-900">{kpis.sentViaSMS}</p>
                    </div>
                    <div className="p-4 rounded-xl bg-green-500/10 border border-green-500/20">
                      <div className="flex items-center gap-2 mb-2">
                        <MessageCircle className="h-4 w-4 text-green-400" />
                        <span className="text-xs font-medium text-gray-900/60">Via WhatsApp</span>
                      </div>
                      <p className="text-2xl font-bold text-gray-900">{kpis.sentViaWhatsApp}</p>
                    </div>
                  </div>
                  ...
                  <div className="p-4 rounded-xl bg-primary/10 border border-primary/20">
                    ...
                    <ul className="text-sm text-gray-900/70 space-y-1">
                ...
                <CardContent className="p-5">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-900/60">For reception desk</p>
                    </div>
                  </div>
                  <Button onClick={() => setQrDialogOpen(true)} variant="outline" className="w-full border-gray-600/50 text-gray-900 hover:bg-slate-700/50">
                    Open QR Studio
                  </Button>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/90 border border-gray-700/50 shadow-lg">
                <CardContent className="p-5">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">Total Sent</p>
                      <p className="text-sm text-gray-900/60">All channels</p>
                    </div>
                  </div>
                  <p className="text-3xl font-bold text-gray-900">{kpis.totalSent}</p>
                </CardContent>
              </Card>
            </div>
          </div>
          ...
          <Card className="bg-white/90 border border-gray-700/50 shadow-lg">
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription className="text-gray-900/60">Monitor sent requests and their status</CardDescription>
                </div>
                <Button 
                  variant="outline" 
                  size="sm" 
                  onClick={() => refetchRequests()}
                  className="border-gray-600/50 text-gray-900 hover:bg-slate-700/50"
                >
            ...
            <CardContent>
              {requestsLoading ? (
                ...
                <div className="text-center py-12">
                  <Send className="h-12 w-12 mx-auto text-gray-900/20 mb-4" />
                  <p className="text-gray-900/60">No requests sent yet</p>
                ...
                <ScrollArea className="h-[400px]">
                  <div className="space-y-2 pr-4">
                    {reviewRequests.map((req) => (
                      <div key={req.id} className="flex items-center justify-between p-4 rounded-xl bg-slate-900/50 border border-gray-700/50">
                        <div className="flex items-center gap-4">
                          <div className={cn(
                          ...
                          <div>
                            <p className="font-medium text-gray-900">{req.recipient_name}</p>
        ...
        <TabsContent value="ai" className="mt-6">
          <Card className="bg-white/90 border border-gray-700/50 shadow-lg">
            ...
            <CardHeader>
              ...
              <CardDescription className="text-gray-900/60">Smart recommendations based on your data</CardDescription>
            </CardHeader>
            <CardContent>
