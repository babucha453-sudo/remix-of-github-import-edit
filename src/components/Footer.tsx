        ...
        <div className="container py-12 px-4">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="space-y-4">
                {ACTIVE_STATES.slice(0, 4).map((state) => (
                  <div key={state.slug}>
                    <Link to={`/${state.slug}/`} className="text-sm font-bold text-white hover:text-emerald-400 transition-colors flex items-center gap-1 mb-2">
                      {state.name}
          ...
          <div className="border-t border-white/10 mt-10 pt-8">
            <nav aria-label="Dental Services" className="flex flex-wrap gap-x-4 gap-y-2 items-center">
              <span className="text-xs font-bold text-slate-500 uppercase mr-2">Services:</span>
